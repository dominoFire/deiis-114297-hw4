 ...
 * 
 */
package edu.cmu.lti.f13.hw4.hw4_114297;
...
import edu.cmu.lti.f13.hw4.hw4_114297.annotators.DocumentVectorAnnotator;

public class VectorSpaceRetrieval {

	public static void main(String[] args) throws Exception {	
		DocumentVectorAnnotator.stopwords = DocumentVectorAnnotator.loadStopwords();
		String sLine;
